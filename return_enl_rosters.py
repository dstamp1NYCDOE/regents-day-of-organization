...
def main(data):
    ...
    testing_accommodations_filename = glob.glob(
        f"data/{administration}/*Testing Accommodations*.csv"
    )[0]
    ...
    for (
        ...
        filename = (
            f"output/{administration}/ENLRosters/{day_as_str}_{time}_{exam_title}.pdf"
        )
